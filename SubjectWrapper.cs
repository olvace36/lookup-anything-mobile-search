...
namespace LookupAnythingMobileSearch.Framework
{
    public class SubjectWrapper
    {
        ...
        // Maps monster name -> i18n key suffix for its 'actual stats'
        // field. The actual text lives in i18n/default.json and
        // i18n/th.json (keys "monster.stats.<slug>"), not here -
        // this table just says which monsters HAVE an entry.
        internal static readonly Dictionary<string, string> MonsterStatsI18nKeys = new(StringComparer.OrdinalIgnoreCase)
        {
            ["Sludge"] = "monster.stats.sludge",
            ["Frost Jelly"] = "monster.stats.frost-jelly",
            ["Purple Slime"] = "monster.stats.purple-slime",
            ["Copper Slime"] = "monster.stats.copper-slime",
            ["Iron Slime"] = "monster.stats.iron-slime",
            ["Yellow Slime"] = "monster.stats.yellow-slime",
            ["Black Slime"] = "monster.stats.black-slime",
            ["Shadow Guy"] = "monster.stats.shadow-guy",
            ["Skeleton Warrior"] = "monster.stats.skeleton-warrior",
            ["Stick Bug"] = "monster.stats.stick-bug",
            ["Mutant Grub"] = "monster.stats.mutant-grub",
            ["Mutant Fly"] = "monster.stats.mutant-fly",
            ["Haunted Skull"] = "monster.stats.haunted-skull",
            ["ES Mine Bat Iridium"] = "monster.stats.es-mine-bat-iridium",
            ["Apophis"] = "monster.stats.apophis",
            ["Badlands Serpent"] = "monster.stats.badlands-serpent",
            ["Bully Rex"] = "monster.stats.bully-rex",
            ["Corrupt Mummy"] = "monster.stats.corrupt-mummy",
            ["Corrupt Serpent"] = "monster.stats.corrupt-serpent",
            ["Corrupt Spirit"] = "monster.stats.corrupt-spirit",
            ["Fallen Adventurer"] = "monster.stats.fallen-adventurer",
            ["Legendary Gold Slime"] = "monster.stats.legendary-gold-slime",
            ["Legendary Purple Mushroom Crab"] = "monster.stats.legendary-purple-mushroom-crab",
            ["Legendary Sand Scorpion"] = "monster.stats.legendary-sand-scorpion",
            ["Poltergeist"] = "monster.stats.poltergeist",
            ["Sand Scorpion"] = "monster.stats.sand-scorpion",
            ["Swamp Golem"] = "monster.stats.swamp-golem",
            ["Swamp Lurk"] = "monster.stats.swamp-lurk",
            ["Swamp Putrid Ghost"] = "monster.stats.swamp-putrid-ghost",
            ["Swamp Flower Crab"] = "monster.stats.swamp-flower-crab",
            ["Toxic Bubble"] = "monster.stats.toxic-bubble",
            ["Toxic Bubble (Weak Variant)"] = "monster.stats.toxic-bubble-weak-variant",
            ["Royal Badlands Serpent"] = "monster.stats.royal-badlands-serpent",
            ["Copper Crab"] = "monster.stats.copper-crab",
            ["Gold Crab"] = "monster.stats.gold-crab",
            ["Iron Crab"] = "monster.stats.iron-crab",
            ["Beast 1"] = "monster.stats.beast-1",
            ["Beast 2"] = "monster.stats.beast-2",
            ["Beast 3"] = "monster.stats.beast-3",
            ["Corrupted Spirit"] = "monster.stats.corrupted-spirit",
            ["Serperial"] = "monster.stats.serperial",
            ["Viperial"] = "monster.stats.viperial",
            ["Wraith"] = "monster.stats.wraith",
        };

        // Same idea for the 'combat tips' field (i18n keys
        // "monster.tips.<slug>").
        internal static readonly Dictionary<string, string> MonsterTipsI18nKeys = new(StringComparer.OrdinalIgnoreCase)
        {
            ["Sludge"] = "monster.tips.sludge",
            ["Frost Jelly"] = "monster.tips.frost-jelly",
            ["Shadow Guy"] = "monster.tips.shadow-guy",
            ["Skeleton Warrior"] = "monster.tips.skeleton-warrior",
            ["Armored Bug"] = "monster.tips.armored-bug",
            ["Assassin Bug"] = "monster.tips.assassin-bug",
            ["Stick Bug"] = "monster.tips.stick-bug",
            ["Mutant Grub"] = "monster.tips.mutant-grub",
            ["Mutant Fly"] = "monster.tips.mutant-fly",
            ["Haunted Skull"] = "monster.tips.haunted-skull",
            ["ES Mine Bat"] = "monster.tips.es-mine-bat",
            ["ES Mine Bat Iridium"] = "monster.tips.es-mine-bat-iridium",
            ["Copper Crab"] = "monster.tips.copper-crab",
            ["Gold Crab"] = "monster.tips.gold-crab",
            ["Iron Crab"] = "monster.tips.iron-crab",
            ["Legendary Purple Mushroom Crab"] = "monster.tips.legendary-purple-mushroom-crab",
            ["Royal Badlands Serpent"] = "monster.tips.royal-badlands-serpent",
            ["Serperial"] = "monster.tips.serperial",
            ["Viperial"] = "monster.tips.viperial",
            ["Wraith"] = "monster.tips.wraith",
            ["Corrupted Spirit"] = "monster.tips.corrupted-spirit",
            ["Beast 1"] = "monster.tips.beast-1",
            ["Beast 2"] = "monster.tips.beast-2",
            ["Beast 3"] = "monster.tips.beast-3",
            ["Toxic Bubble"] = "monster.tips.toxic-bubble",
